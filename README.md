...
Now that you managed to create an image that is able to launch a Joint Trajectory Controller, let's modify the launch and config files to configure the ICON HWM Controller instead. This requires:
- Modifications to the launch file:
  - Additional launch file parameters specific to the ROS 2 Controller.
