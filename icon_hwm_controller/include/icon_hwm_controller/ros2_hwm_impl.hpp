...
class Ros2HwmImpl final : public intrinsic::icon::HardwareModuleInterface {
 ...
 private:
  ...
  rclcpp::Subscription<icon_hwm_controller_msgs::msg::OperationalStatus>::SharedPtr operational_status_subscription_;
  // RealtimeThreadSafeBox for the latest OperationalStatus value, so the realtime functions can safely read it.
  realtime_tools::RealtimeThreadSafeBox<icon_hwm_controller_msgs::msg::OperationalStatus> latest_operational_status_;
  // Service Clients
