#ifndef ICON_HAL_HARDWARE_MODULE_UTIL_H_
#define ICON_HAL_HARDWARE_MODULE_UTIL_H_
...
class SharedPromiseWrapper {
 ...
 private:
  ...
  std::optional<std::promise<T>> promise_ INTR_GUARDED_BY(mutex_) =
      std::promise<T>();
...
#endif  // ICON_HAL_HARDWARE_MODULE_UTIL_H_
